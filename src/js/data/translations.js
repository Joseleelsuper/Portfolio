/**
 * Traducciones i18n
 * @description Textos en español e inglés para internacionalización
 */
  ...
  es: {
    ...
    about: {
      ...
      highlights: {
        education: {
          title: "Formación",
          text: "Base universitaria en Ingeniería Informática y aprendizaje orientado a proyectos reales."
        },
        stack: {
          title: "Stack técnico"
        },
  ...
  en: {
    ...
    about: {
      ...
      highlights: {
        education: {
          title: "Education",
          text: "University foundation in Computer Engineering with project-oriented learning."
        },
        stack: {
